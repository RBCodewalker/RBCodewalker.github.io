...
export const data=[
    {
        ...
        description:"Interactive German citizenship test preparation app with AI-powered explanations (beta), quiz modes, and progress tracking built with React and Web LLM integration.",
        image:projectEC,
